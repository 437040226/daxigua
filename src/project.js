    ...
    var o = e("HttpManagerJs"),
      ...
      r = (e("GameUiTools"), {
        ...
        ajaxLoad: function (e, t, n) {
          ...
          // 将数据拼接为查询字符串
          var query = new URLSearchParams(t).toString();
          o.open("GET", e + "?" + query); // 改为 GET
          o.send();
        },
        scoreResult: function (e) {
          if (null != e.currentTarget.response && "" != e.currentTarget.response && e.currentTarget.response.trim().startsWith('<!DOCTYPE') == false) {
